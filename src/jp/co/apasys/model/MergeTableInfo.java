...
public class MergeTableInfo {
    ...
    private String newTableAllColumn = "";
    ...
    private List<String> newTableAllColumnList = new ArrayList<String>();
    ...
    private String oldTableAllColumn = "";
    ...
    private List<String> oldTableAllColumnList = new ArrayList<String>();
	...
	public String getNewTableAllColumn() {
		return newTableAllColumn;
	}
	public void setNewTableAllColumn(String newTableAllColumn) {
		this.newTableAllColumn = newTableAllColumn;
	}
	...
	public List<String> getNewTableAllColumnList() {
		return newTableAllColumnList;
	}
	public void setNewTableAllColumnList(List<String> newTableAllColumnList) {
		this.newTableAllColumnList = newTableAllColumnList;
	}
	...
	public String getOldTableAllColumn() {
		return oldTableAllColumn;
	}
	public void setOldTableAllColumn(String oldTableAllColumn) {
		this.oldTableAllColumn = oldTableAllColumn;
	}
	...
	public List<String> getOldTableAllColumnList() {
		return oldTableAllColumnList;
	}
	public void setOldTableAllColumnList(List<String> oldTableAllColumnList) {
		this.oldTableAllColumnList = oldTableAllColumnList;
	}
