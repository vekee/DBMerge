...
public class AutoCreate {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			while (newRs.next()) {
				autoCreateThread = new AutoCreateThread(newRs.getString("TABLE_NAME"));
			...
			loggerUtil.error("exception happened", e);
		}
	...
	private static void waitForCreateTablesThreadFinished(CopyOnWriteArraySet<AutoCreateThread> threadSet)
	...
	private static void waitForCreateTablesThread(CopyOnWriteArraySet<AutoCreateThread> threadSet)
			throws InterruptedException {
