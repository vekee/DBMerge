...
public class MergeTable {
	...
	mergeTableInfo.setNewTableAllColumn(properties
		.getProperty(newTableAllColumn));
	...
	mergeTableInfo.setNewTableKeyColumnList(splitToList(properties
		.getProperty(newTableKeyColumn)));
	mergeTableInfo.setNewTableAllColumnList(splitToList(properties
		.getProperty(newTableAllColumn)));
	...
	mergeTableInfo.setOldTableAllColumn(properties
		.getProperty(oldTableAllColumn));
	...
	mergeTableInfo.setOldTableKeyColumnList(splitToList(properties
		.getProperty(oldTableKeyColumn)));
	mergeTableInfo.setOldTableAllColumnList(splitToList(properties
		.getProperty(oldTableAllColumn)));
